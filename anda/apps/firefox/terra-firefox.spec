%global terrasrc_commit 6165112dd3b4906e7378d06df7b11aae2bc5235f
%global tsurl https://raw.githubusercontent.com/terrapkg/pkg-firefox/%terrasrc_commit
...
%if %{with langpacks}
Source1:        %tsurl/firefox-langpacks-%{version}%{?pre_version}-20250102.tar.xz
%endif
Source2:        %tsurl/cbindgen-vendor.tar.xz
Source3:        %tsurl/dump_syms-vendor.tar.xz
Source10:       %tsurl/firefox-mozconfig
Source12:       %tsurl/firefox-redhat-default-prefs.js
Source20:       %tsurl/firefox.desktop
Source21:       %tsurl/firefox.sh.in
Source23:       %tsurl/firefox.1
Source24:       %tsurl/mozilla-api-key
Source25:       %tsurl/firefox-symbolic.svg
Source26:       %tsurl/distribution.ini
Source27:       %tsurl/google-api-key
Source28:       %tsurl/firefox-wayland.sh.in
Source29:       %tsurl/firefox-wayland.desktop
Source30:       %tsurl/firefox-x11.sh.in
Source31:       %tsurl/firefox-x11.desktop
Source32:       %tsurl/node-stdout-nonblocking-wrapper
Source33:       %tsurl/firefox.appdata.xml.in
Source34:       %tsurl/org.mozilla.firefox.search-provider.ini
Source35:       %tsurl/google-loc-api-key
Source37:       %tsurl/mochitest-python.tar.gz
Source38:       %tsurl/print_results
Source39:       %tsurl/print-errors
Source40:       %tsurl/run-tests-x11
Source41:       %tsurl/run-tests-wayland
Source42:       %tsurl/psummary
Source43:       %tsurl/print_failures
Source44:       %tsurl/print-error-reftest
Source45:       %tsurl/run-wayland-compositor
Source46:       %tsurl/org.mozilla.firefox.SearchProvider.service
Source47:       %tsurl/org.mozilla.firefox.desktop
Source48:       %tsurl/org.mozilla.firefox.appdata.xml.in
Source49:       %tsurl/wasi.patch.template
# Created by:
# git clone --recursive https://github.com/WebAssembly/wasi-sdk.git
# cd wasi-sdk && git-archive-all --force-submodules wasi-sdk-20.tar.gz
Source50:       %tsurl/wasi-sdk-20.tar.gz

# Build patches
#Patch3:         mozilla-build-arm.patch
Patch32:        %tsurl/build-rust-ppc64le.patch
Patch35:        %tsurl/build-ppc-jit.patch
# Fixing missing cacheFlush when JS_CODEGEN_NONE is used (s390x)
Patch38:        %tsurl/build-cacheFlush-missing.patch
Patch40:        %tsurl/build-aarch64-skia.patch
Patch44:        %tsurl/build-arm-libopus.patch
Patch46:        %tsurl/firefox-nss-version.patch
Patch53:        %tsurl/firefox-gcc-build.patch
Patch55:        %tsurl/firefox-testing.patch
Patch61:        %tsurl/firefox-glibc-dynstack.patch
Patch71:        %tsurl/0001-GLIBCXX-fix-for-GCC-12.patch
Patch78:        %tsurl/firefox-i686-build.patch
Patch79:        %tsurl/firefox-gcc-13-build.patch
Patch80:        %tsurl/wasi.patch
...
Patch100:       %tsurl/firefox-tests-xpcshell.patch
Patch101:       %tsurl/firefox-tests-reftest.patch
Patch102:       %tsurl/firefox-tests-xpcshell-freeze.patch

# Fedora specific patches
Patch215:        %tsurl/firefox-enable-addons.patch
Patch219:        %tsurl/rhbz-1173156.patch
#ARM run-time patch
Patch226:        %tsurl/rhbz-1354671.patch
Patch228:        %tsurl/disable-openh264-download.patch
Patch229:        %tsurl/firefox-nss-addon-hack.patch
Patch230:        %tsurl/firefox-enable-vaapi.patch
Patch231:        %tsurl/fedora-customization.patch
Patch241:        %tsurl/0025-Add-KDE-integration-to-Firefox-toolkit-parts.patch
Patch242:        %tsurl/0026-Add-KDE-integration-to-Firefox.patch

# Upstream patches
Patch402:        %tsurl/mozilla-1196777.patch
Patch407:        %tsurl/mozilla-1667096.patch
Patch408:        %tsurl/mzbz-1934217.patch

# PGO/LTO patches
Patch600:        %tsurl/pgo.patch
Patch602:        %tsurl/mozilla-1516803.patch
Patch603:        %tsurl/firefox-gcc-always-inline.patch

# system AV1 patches (from Gentoo)
Patch800:        %tsurl/bmo-1559213-Support-system-av1.patch
Patch801:        %tsurl/bmo-1559213-fix-system-av1-libs.patch
...
%if !0%{?flatpak}
%dnl cp -p %{default_bookmarks_file} objdir/dist/bin/browser/chrome/browser/content/browser/default-bookmarks.html
%endif
